...
<html>
    ...
    if (messageSucess
        ...
        messageSucess = "";
                ...
                <h1 class="message"><%=messageSucess%></h1></br>

                <a href="MainController?action=viewCart&cid=<%= request.getAttribute("cid")%>&username=<%= request.getParameter("username")%> "><button type="button" class="btn btn-success">View Cart</button></a>
                <%
        ...
        <div class="Panner1">
            <div class="d-flex mt-3" style="width: 100%;">
                <div class="Panner2" style="width: 20%;background: #ddd;padding: 60px;">
                    ...
                    %>
                    <a href="MainController?action=listByCa&cateId=<%= ca.getCateId()%>&cid=<%= request.getParameter("cid")%>&username=<%= request.getParameter("username")%>"> <%= ca.getCateName()%></a>
                    <%}%>


                    <%

                        List<Product> listCProduct = (List<Product>) session.getAttribute("LIST_PRODUCT_CATEID");
