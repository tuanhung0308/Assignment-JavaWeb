...
<html>
    ...
    <body>
        ...
        <div class="Panner">
            ...
            <a href="MainController?action=viewCart&cid=<%= request.getParameter("cid")%>&username=<%= request.getParameter("username")%> "><button type="button" class="btn btn-success">View Cart</button></a>
            <%
