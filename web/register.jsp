<%-- 
    Document   : register
    Created on : Feb 23, 2023, 4:49:49 AM
    Author     : Admin
--%>
            ...
            <article class="card-body">
                ...
                <form action="MainController" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="username" type="text" name="cid">
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Address:" type="text" name="phone">
                    </div> 
                    <div class="form-group">
